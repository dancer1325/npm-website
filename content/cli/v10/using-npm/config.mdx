...
* goal
    * npm configuration in general
* if you want to learn about the `config` command -> see [`npm config`](/cli/v10/commands/npm-config)
* ways to pass configuration values to npm -- sorted by -- priority
